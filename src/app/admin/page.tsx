...
function SortableItem({ product, children }: { product: Product; children: React.ReactNode }) {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    <div ref={setNodeRef} style={style} {...attributes}>
      <div className="flex items-start">
        ...
        <div 
          {...listeners}
          className="flex-shrink-0 p-3 cursor-grab hover:bg-gray-100 rounded mr-3 flex items-center justify-center self-center"
        >
...
export default function AdminPanel() {
  ...
  // Ürün sıralama fonksiyonları artık drag & drop ile yapılıyor
                      ...
                      <div className="flex flex-col space-y-2">
                        ...
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="flex items-center space-x-1 bg-blue-100 hover:bg-blue-200 text-blue-700 px-3 py-2 rounded-lg text-sm font-medium transition-colors"
                          >
